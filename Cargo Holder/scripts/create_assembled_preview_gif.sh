...
do
    openscad "../3d-models/openscad files/assembled.scad" -o ".tmp_assembled_preview_gif/assembled_$vertical_gap.png" -D "vertical_gap=$vertical_gap;" --imgsize 800,600 --camera 80,71,83,52,0,57,718 --render
done
